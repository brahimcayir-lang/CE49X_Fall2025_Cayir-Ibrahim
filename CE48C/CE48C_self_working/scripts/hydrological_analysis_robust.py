...
def create_correlation_analysis(df):
    ...
    # Scatter plot
    plt.scatter(valid_data['annual_lps_km2'], valid_data['annual_total_m3_million'], 
               s=100, alpha=0.7, c=valid_data['year'], cmap='viridis', edgecolors='black')
...
def create_extreme_flow_analysis(df):
    ...
    if annual_max:
        ax1.plot(years, annual_max, 'o-', linewidth=2, markersize=6, color='red', label='Annual Maximum')
    ...
    if annual_min:
        ax2.plot(years, annual_min, 'o-', linewidth=2, markersize=6, color='blue', label='Annual Minimum')
